...
var banner =
  '/* somehow v' + pkg.version + '\n   github.com/spencermountain/somehow-circle\n   MIT\n*/\n'
var uncompressed = './builds/somehow-circle.js'
var compressed = './builds/somehow-circle.min.js'
...
var cmd = browserify + ' ./src/index.js --standalone somehowCircle'
