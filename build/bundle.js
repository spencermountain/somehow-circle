...
var app = (function () {
    ...
    const layout = function (items, data) {
      ...
      let rScale = scaleLinear({ minmax: [0, data.radius], world: [-50, 50] });
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path, file, 34, 4, 689);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(svg, file, 32, 0, 593);
    		},
    ...
    function create_default_slot(ctx) {
    	...
    	arc0 = new Arc({
    			props: { from: "0", to: "45", color: "blue" },
    			$$inline: true
    		});

    	arc1 = new Arc({
    			props: { from: "45", to: "90", color: "red" },
    			$$inline: true
    		});
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(13:2) <Round from=\\\"0\\\" to=\\\"360\\\">",
    		ctx
    	});
